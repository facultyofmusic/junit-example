...
public class SPRunner extends Suite {
    ...
    public SPRunner(Class<?> klass, RunnerBuilder builder) throws InitializationError {
    ...
    private static class BSRunner extends BlockJUnit4ClassRunner {
        ...
        protected Statement methodBlock(FrameworkMethod method) {
            System.setProperty("who-is-running", person.name());
